...
<head>
  ...
  <title>HRM Project Net - 결재내용</title>
...
<%
int appresult = (int)request.getAttribute("appresult");
String appResult;
if(appresult==0){appResult="대기중";}
else if(appresult==1){appResult="승인";}
else{appResult="반려";}
%>
</script>
            ...
            <div class="card-body" style="display:inline;">
              <div class="table-responsive" style="display:inline">
                <table class="table" id="writeapp"> 
                    <tr>
					<td width="150" bgcolor="gray" style="color:white;text-align: center;">상신자</td>
					<td>${appdto.writer}</td>
					<td width="150" bgcolor="gray" style="color:white;text-align: center;">상신일</td>
					<td>${appdto.formatdate}</td>
					</tr>
					<tr>
					<td width="150" bgcolor="gray" style="color:white;text-align: center;">제목</td>
					<td colspan="3">${appdto.subject}</td>
					</tr>
					<tr id="file">
					...
					<tr>
					<td width="150" bgcolor="gray" style="color:white;text-align: center;">결재여부</td>
					<td colspan="3"><%=appResult%></td>
					</tr>
                </table>
                <hr>
