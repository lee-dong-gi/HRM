...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="/HRMProjectMain/jsp/approve/appboard?pageNum=1"> <i class="fas fa-fw"></i> <span>결재</span>
			</a></li>
									...
									<div class>
										<div class="row">
											<div class="col-lg-12 text-center" style="padding-top:5%">
												<h4><a class="d-flex justify-content-center" href="/HRMProjectMain/jsp/user/mainadmin"> HRM<sup>Project</sup> <strong>Attendance Management</strong>
												</a></h4>
