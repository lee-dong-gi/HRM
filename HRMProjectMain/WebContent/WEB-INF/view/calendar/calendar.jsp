...
<div class="container-fluid">
    <div class="h3 mb-4 text-gray-800 text-center cal_title_wrap">
        <a href="calendar?year=${today.bYear}&month=${today.bMonth}" class="btn btn-primary btn-circle">
            <i class="fa fa-angle-left fa-2x"></i>
        </a>
        <span class="cal_title">${today.tYear}년 ${today.tMonth}월</span>
        <a href="calendar?year=${today.aYear}&month=${today.aMonth}" class="btn btn-primary btn-circle">
            <i class="fa fa-angle-right fa-2x"></i>
        </a>
        <div id="add" class="cal_add">
            <a class="btn btn-success btn-circle" href="register">
...
<tbody>
	...
	<tr class="row">
		...
		<div class="cal_date_content" style = "cursor:pointer;" onClick = "location.href='check?num=${dto.num}'">${dto.title}</div>
		</c:forEach>		
		</div>
		</td>
		</c:when>
