				...
				<div class="container-fluid">
					...
					<div class="container">
						...
						<div align="center">
							<table style="width: 100%;" class="table">
								...
								<tr align="center" style="border-bottom: 1px solid #ced4da;">
									...
									<td
										style="border-right: 1px solid #ced4da; padding: 3%; text-align: left;">${cal.content}</td>
						...
						<div class="row justify-content-between" style="margin: 0">
							...
							<div>
								<input id="upd" class="btn btn-secondary" type="button"
									value="수정" onclick="location.href='update?num=${cal.num}'">
								<input id="del" class="btn btn-secondary" type="button"
