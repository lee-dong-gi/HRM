...
$(function(){
	...
	if(${empno} != ${cal.empno}){
		$("#upd").prop("type", "hidden");
	}
});
function del(){
	if(confirm("정말 삭제하시겠습니까?")){
	var param = "num="+"${cal.num}";
	$.ajax({
		type:"get",
	    url:"delete",
	    data:param,
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<hr class="sidebar-divider">
       	<!-- Content Row -->
<div class="container">
<h2 class="h2" style="padding-top: 100px; font-weight: bold;">일정보기</h2>
<hr>
...
<tr align="center" style="background-color: #ced4da;">
<td style="font-weight: bold; width: 20%;">제 목</td>
<td style="font-weight: bold;">내 용</td>
<td style="font-weight: bold; width: 16%">기 간</td>
<td style="font-weight: bold; width: 10%">작성자</td>
</tr>


<tr align="center" style="border-bottom: 1px solid #ced4da;">
<td style="border-right: 1px solid #ced4da; padding: 3%;">${cal.title}</td>
<td style="border-right: 1px solid #ced4da; padding: 3%; text-align: left;">${cal.content}</td>
<td style="border-right: 1px solid #ced4da; padding: 3%;">${cal.startDate} ~ 
${cal.endDate}</td>
<td style="padding: 3%;">${cal.writer}</td>
</tr>
...
<div><input class="btn btn-primary" type="button" value="목록" onclick="location.href='calendar'"></div>
<div><input id="upd" class="btn btn-secondary" type="button" value="수정" onclick="location.href='update?num=${cal.num}'">
<input id="del" class="btn btn-secondary" type="button" value="삭제" onclick="del()"></div>
</div>
</div>
        <!-- /.container-fluid -->
