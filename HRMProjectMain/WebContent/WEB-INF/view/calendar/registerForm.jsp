...
<td><%=username%><input type="hidden" name="empno" value="<%=userempno%>"><input type="hidden" name="writer" value="<%=username%>"></td>
</tr>
<tr>
<td>내용</td>
<td>
...
<div class="row">
<div class="col">
<input class="form-control" type="datetime" name="startDate" pattern="[0-9]{8}" title="예 : 20200413">
</div>
&emsp;-&emsp;
<div class="col">
<input class="form-control" type="datetime" name="endDate" pattern="[0-9]{8}" title="예 : 20200413">
</div>
</div>
</td>
</tr>
...
<div><input class="btn btn-secondary" type="submit" value="등록"></div>
</div>
</form>
