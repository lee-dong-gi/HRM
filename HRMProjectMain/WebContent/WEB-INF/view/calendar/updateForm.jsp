...
%>
function upd(){
	var param = "num="+"${cal.num}"+"&content="+$("#contenttext").val();
	$.ajax({
		type:"post",
	    url:"update",
	    data:param,
...
<td>내용</td>
<td>
<textarea id="contenttext" class="form-control" rows="10" style="width: 100%"></textarea>
</td>
</tr>
<tr>
<td>기간</td>
...
<div><input class="btn btn-primary" type="button" value="취소" onclick="location.href='calendar'"></div>
<div><input class="btn btn-secondary" type="button" value="수정" onclick="upd()"></div>
</div>
