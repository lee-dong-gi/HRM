          ...
          <div class="card shadow mb-4" style="width:100%;">
            ...
            <div class="card-body">
              <div class="table-responsive">
               <form action="createroom" method="post" onsubmit='return checkwrite()'>
                <table class="table table-bordered" id="writeapp">
					...
					<td>
					<input type="hidden" id="creatorid" name="creatorid" value="${creater}">${creater}
					</td>
					</tr>
					<tr>
					<td bgcolor="gray" style="color:white;">
					...
					<td>
					<input class="form-control" type="text" id="chatroomname" name="chatroomname" onkeypress="txtMaxlength()" style="width:90%;"> 
					</td>
					</tr>
					<tr>
					<td bgcolor="gray" style="color:white;">
					...
					<td>
					<textarea class="form-control" id="description" name="description" class="md-textarea form-control" rows="10" cols="30" onkeypress="txtMaxlength()" style="width:90%;"></textarea><br>
					</td>
					</tr>
                </table>
					<a href="chatroomadmin" class="btn btn-secondary btn-sm">목록</a>
					<button type="reset" class="btn btn-secondary btn-sm">다시쓰기</button>
					<button type="submit" class="btn btn-secondary btn-sm" style="float: right">생성</button>
					</form>               
              </div>            
				</div>
				</div>
