...
<head>
  ...
  <title>HRM Project Net Admin- 채팅방 선택</title>
			...
			for(var i=0; i < args.length; i++) {
				 $("#chatroom").append("<tr><td>" + args[i].chatroomname+"</td>"+
											"<td>" + args[i].formatdate+"</td>"+
						 					...
						 					"<td><input type='checkbox' name='checkchat' value='"+args[i].chatroomnum+"'></td>"+
						 					"<td><a href=# onclick=window.open(&#39;chatbroad?chatname="+
						 					args[i].chatroomname+
						 					"&#39;,&#39;win2&#39;,&#39;scrollbars=yes&#32;width=800,&#32;height=800&#39;);return false><i class='fas fa-comments'>참여</i></a></td></tr>");
						 					/* "<td><a href='chatbroad?chatname="+args[i].chatroomname+"'><i class='fas fa-comments'>참여</i></a></td>"); */
			 }
			})
	    .fail(function(e) {
		...
		<hr class="sidebar-divider">
          ...
          <div class="card shadow mb-3">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">채팅방 관리</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
              <form action="chatdel" method="POST">
                ...
                <hr class="sidebar-divider">
                <button type="submit" id="delchat" class="btn btn-secondary btn-sm">채팅방 삭제</button>
                <a href="addchat" class="btn btn-secondary btn-sm">채팅방 추가</a>                 	                    
                <a href="chatbroadcast?chatname=admin" class="btn btn-secondary btn-sm">채팅공지</a>                 	                    
                </form>              	                    
					</div>
				</div>
			</div>
