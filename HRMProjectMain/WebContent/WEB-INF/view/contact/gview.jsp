					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<form name="form1" method="post">
									<table class="table table-bordered" id="contact" width="20%"
										...
										<thead>
											<tr>
												<td colspan="4"><b> 그룹이름 : ${gdto.gname}</b><br></td>
											</tr>
										</thead>
										<tr>
										</tr>
							...
							<div id="pageCount" style="display: inline">
								<span id="pageCo" style="display: inline"></span> <a
									href="contact/gupdate.do?gnum=${gdto.gnum }"
									class="btn btn-secondary btn-sm">수정</a> <a
									href="contact/gdelete.do?gnum=${gdto.gnum }" id="delete"
