				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">
								...
								<span style="float: right"><button id="btngroup"
					...
					<div class="card shadow mb-4">
						...
						<a href="#collapseCardExample" class="d-block card-header py-3"
							...
							<h6 class="m-0 font-weight-bold text-primary">연락처 내보내기</h6>
						</a>
						<!-- Card Content - Collapse -->
						<div class="collapse hide" id="collapseCardExample">
							<div class="card-body">
								<form id="excelForm" name="excelForm" method="post"
									action="contact/exceldown.do">
									<input type="text" name="fileName" placeholder="파일명을 입력하세요">
									<input type="submit" value="연락처 내보내기"
					...
					<div class="card shadow mb-4">
						...
						<a href="#collapseCardExample1" class="d-block card-header py-3"
							data-toggle="collapse" role="button" aria-expanded="true"
							aria-controls="collapseCardExample">
							<h6 class="m-0 font-weight-bold text-primary">엑셀 업로드</h6>
						</a>
						<!-- Card Content - Collapse -->
						<div class="collapse hide" id="collapseCardExample1">
							<div class="card-body">
								<form id="excelUploadForm" name="excelUploadForm"
									...
									action="contact/excelUploadAjax.do">
									<div class="contents">

										<input id="excelFile" type="file" name="excelFile" />
										<button type="button" id="addExcelImpoartBtn"
											class="btn btn-secondary btn-sm" onclick="check()">
											<span>업로드</span>
										</button>
									</div>
								</form>
