						...
						<div class="card-body">
							<div class="table-responsive">
								<form name="update" method="post">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
										이름 :<input value="${dto.name}" name="name" id="name" size="30"
											class="form-control form-control-user">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										직급/부서 : <input value="${dto.level}" name="level" id="level"
											size="30" class="form-control form-control-user">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										회사명 : <input value="${dto.compname}" name="compname"
											id="compname" size="30"
											class="form-control form-control-user">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										이메일 : <input value="${dto.email}" name="email" id="email"
											size="30" class="form-control form-control-user">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										전화번호 : <input value="${dto.phonenum}" name="phonenum"
											id="phonenum" size="30"
											class="form-control form-control-user">
									</div>
