	...
	function check() {
		...
		$.ajax({
			...
			if (json == "yes") {
				...
				window.location.href = "showId?" + param;
			}
		}).fail(function() {
			alert("실패")
		})
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#">
					<i class="fas fa-fw"></i> <span>캘린더</span>
			</a></li>
			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item"><a class="nav-link collapsed" href="#">
					<i class="fas fa-fw"></i> <span>투표</span>
			</a></li>
			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item"><a class="nav-link collapsed" href="#">
					<i class="fas fa-fw"></i> <span>근태관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
				href="/HRMProjectMain/jsp/notice/list"> <i class="fas fa-fw"></i>
					<span>공지사항</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
				href="/HRMProjectMain/jsp/notice/list"> <i class="fas fa-fw"></i>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#">
					<i class="fas fa-fw"></i> <span>자유게시판</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#">
					<i class="fas fa-fw"></i> <span>조직도</span>
			</a></li>
						...
						<div class="container">
							...
							<div class="form-group"
								...
								<div class="col-sm-offset-2 col-sm-10">
									...
									<input type="button" value="아이디 찾기" class="btn btn-secondary"
										onclick="check()">
								</div>
							</div>
						</div>
