				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">자유게시판 등록</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<div></div>
								<form action="ins" method="post" onsubmit="return check()">
									<table class="table table-bordered" id="writeapp" width="120%"
										cellspacing="0">
										<tr>
											<td>작성자</td>
											<td>${name}<input type="hidden" name="writer" value="${name}"><input type="hidden" name="id" value="${id}"></td>
										</tr>
										<tr>
											<td>제목</td>
										...
										<tr>
											<td>내용</td>
											<td><textarea class="form-control" id="contentt" rows="10" cols="30" name="content" style="width: 60%;"></textarea><br>
											</td>
										</tr>
									</table>
									<div class="row justify-content-between" style="margin: 0">
										...
										<div>
											<input class="btn btn-secondary btn-icon-split"
