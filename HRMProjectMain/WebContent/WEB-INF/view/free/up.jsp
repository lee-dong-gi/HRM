				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">자유게시판 글수정</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<div></div>
								<form action="up" method="post" onsubmit="return check()">
									<input type="hidden" value="${up.num}" name="num">
									<table class="table table-bordered" id="writeapp" width="120%"
										...
										<tr>
											...
											<td><textarea class="form-control" rows="10" cols="30"
													style="width: 60%;" name="content" id="updatec"></textarea></td>
										</tr>
									</table>
