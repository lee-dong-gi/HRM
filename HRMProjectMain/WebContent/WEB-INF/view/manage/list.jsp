						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<table class="table table-bordered"
									...
									<thead>
										<tr>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">사원번호</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">부서</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">이름</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">아이디</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">생년월일</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">email</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">전화번호</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">입사일자</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">직급</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">연봉</td>
											<td bgcolor="gray" style="font-weight: bold; color:white;" align="center">등록확인</td>
										</tr>
										<c:forEach var="list" items="${list}">
											<tr height="30">
												<td align="center" width="250">${list.empno}</td>
												<td align="center" width="250">${list.dname}</td>
												<td align="center" width="250"><a href="manage/emp?id=${list.id}">${list.name}</a></td>
												<td align="center" width="250">${list.id}</td>
												<td align="center" width="250">${list.birth}</td>
												<td align="center" width="250">${list.email}</td>
												<td align="center" width="250">${list.phonenum}</td>
												<td align="center" width="250">${list.hiredate}</td>
												<td align="center" width="250">${list.level}</td>
												<td align="center" width="100">${list.salary}</td>
												<td align="center" width="100"><c:choose>
												<c:when test="${list.emailcheck == 0}">X</c:when>
