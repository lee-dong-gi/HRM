            ...
            <div class="card-body">
              ...
              <form method="post">
                <table class="table table-bordered" id="writeapp" width="120%" cellspacing="0">
					...
					<td>
					<input type="hidden" name="writer" value="${name}"><input type="hidden" name="id" value="${id}">${name}
					</td>
					</tr>
					<tr>
					<td>
					...
					<td>
					<textarea id="content" rows="10" cols="30"  name="content" style="width: 60%;"></textarea><br> 
					</td>
					</tr>
                </table>
              </div>
              <div class="row justify-content-between" style="margin:0"><div><a href="list" class="btn btn-secondary btn-icon-split">목록</a></div>
              <div><button class="btn btn-secondary btn-icon-split" type="submit">등록하기</button></div>            
