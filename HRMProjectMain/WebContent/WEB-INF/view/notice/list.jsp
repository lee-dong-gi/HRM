          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
              	<div></div>
                <table class="table table-bordered" style="padding-top: 50px; margin-left: auto; margin-right: auto;">
                  <thead>
                    <tr>
                      <th>번호</th>
                      <th>제목</th>
				...
				<td align="center" width="250"><a href="notice?num=${item.num}" >${item.subject}</a></td>
              ...
              <input type="hidden" id="ins" class="btn btn-secondary btn-icon-split" value="등록하기" onclick="location.href='insert'">
