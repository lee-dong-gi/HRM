		...
		<hr class="sidebar-divider">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div><input type="hidden" id="upd" class="btn btn-secondary btn-icon-split" value="수정하기" onclick="location.href='update?num=${notice.num}'">
					<input type="hidden" id="del" class="btn btn-secondary btn-icon-split" value="삭제하기" onclick="del()"></div>            
